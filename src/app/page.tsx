  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="grid gap-6 gap-y-12 grid-cols-1 md:grid-cols-[1.5fr_1fr] items-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold">Build faster.<br /> Scale smarter.</h1>
      ...
      <section className="max-w-6xl mx-auto px-5 py-16">
        <div className="bg-slate-50 px-6 py-12 md:px-16 md:py-16 rounded-lg">
          <h2 className="text-3xl font-semibold text-center">What makes us different?</h2>
          {/* Features grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            {/* Feature 1 */}
            <div className="space-y-4 p-6 border border-neutral-200 rounded-lg bg-white">
              ...
              <h3 className="text-lg font-semibold">Build faster. Scale smarter.</h3>
